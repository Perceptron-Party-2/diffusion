...
def train_mnist():
    ...
    lrate = 1e-4
    save_model = True
    save_dir = './datapics/diffusion_outputs10/'
                    ...
                    def animate_diff(i, x_gen_store):
                        ...
                        for row in range(int(n_sample/n_classes)):
                            for col in range(n_classes):
                                ...
                                plots.append(axs[row, col].imshow(-x_gen_store[i,(row*n_classes)+col,0],cmap='viridis',vmin=(-x_gen_store[i]).min(), vmax=(-x_gen_store[i]).max()))
                        return plots
